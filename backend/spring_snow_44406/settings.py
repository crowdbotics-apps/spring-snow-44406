"""
Django settings for spring_snow_44406 project.
...
ROOT_URLCONF = 'spring_snow_44406.urls'
...
WSGI_APPLICATION = 'spring_snow_44406.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "spring_snow_44406 API",
    "DESCRIPTION": "API documentation for spring_snow_44406 App",
    "VERSION": "v1",
}
